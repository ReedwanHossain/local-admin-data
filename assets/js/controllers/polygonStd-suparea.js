(function() {
    ...
    angular
        .module('barikoi')
        .controller('PolygonStdSupArea', PolygonStdSupArea);

    PolygonStdSupArea.$inject = ['$scope', '$modal', '$http', '$stateParams', '$window', '$location', '$timeout', 'leafletData', 'urls', 'Auth', 'DataTunnel', 'bsLoadingOverlayService'];

    function PolygonStdSupArea($scope, $modal, $http, $stateParams, $window, $location, $timeout, leafletData, urls, Auth, DataTunnel, bsLoadingOverlayService) {
        // $scope.coordinates=[];
  ...
  leafletData.getMap().then(function(map) {
               leafletData.getLayers().then(function(baselayers) {
                ...
                templateUrl: '/../../examples/polygon-suparea-mod.html',

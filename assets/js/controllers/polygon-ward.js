(function() {
    ...
    angular
        .module('barikoi')
        .controller('PolygonWard', PolygonWard);
        
    PolygonWard.$inject = ['$scope', '$http', '$stateParams', '$window', '$location', '$timeout', 'leafletData', 'urls', 'Auth', 'DataTunnel', 'bsLoadingOverlayService'];
                    ...
                    drawnItems.addLayer(layer);
                     ...
                     var coordinates = array.reduce(
                      ...
                      swal({  
                        ...
                        function(){
                        var data = {
                              ward_area : coordinates.toString()
                            }   
                            Auth.updateSomething(urls.POLYGON_WARD+'/'+$scope.id, data, function(res) {

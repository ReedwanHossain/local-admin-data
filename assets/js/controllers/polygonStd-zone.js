(function() {
    ...
    angular
        .module('barikoi')
        .controller('PolygonStdZone', PolygonStdZone);

    PolygonStdZone.$inject = ['$scope', '$modal', '$http', '$stateParams', '$window', '$location', '$timeout', 'leafletData', 'urls', 'Auth', 'DataTunnel', 'bsLoadingOverlayService'];

    function PolygonStdZone($scope, $modal, $http, $stateParams, $window, $location, $timeout, leafletData, urls, Auth, DataTunnel, bsLoadingOverlayService) {
        // $scope.coordinates=[];
  ...
  leafletData.getMap().then(function(map) {
               ...
               DataTunnel.set_data($scope.coordinates);
                ...
                templateUrl: '/../../examples/polygon-zone-mod.html',

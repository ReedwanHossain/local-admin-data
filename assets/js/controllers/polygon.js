(function() {
    ...
    Polygon.$inject = ['$scope', '$http', '$stateParams', '$window', '$location', 'leafletData', 'urls', 'Auth', 'DataTunnel', 'bsLoadingOverlayService'];

    function Polygon($scope, $http, $stateParams, $window, $location, leafletData, urls, Auth, DataTunnel, bsLoadingOverlayService) {
                    ...
                    drawnItems.addLayer(layer);
                     ...
                     var coordinates = array.reduce(
                      ...
                      swal({  
                        ...
                        showCancelButton: true,   
                        confirmButtonColor: "#DD6B55",   
                        confirmButtonText: "Yes, update Poligon!",   
                        closeOnConfirm: false }, 
                        function(){
                        var data = {
                              area : coordinates.toString()
                            }   
                            Auth.updateSomething(urls.POLYGON_UPDATE+$scope.id, data, function(res) {

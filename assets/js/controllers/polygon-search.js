(function() {
    ...
    angular
        .module('barikoi')
        .controller('PolygonSearch', PolygonSearch);
    PolygonSearch.$inject = ['$scope', '$modal', '$http', '$stateParams', '$window', '$anchorScroll', '$location', 'leafletData', 'urls', 'Auth', 'DataTunnel', 'bsLoadingOverlayService'];

    function PolygonSearch($scope, $modal, $http, $stateParams, $window, $anchorScroll, $location, leafletData, urls, Auth, DataTunnel, bsLoadingOverlayService) {

(function() {
    ...
    PolygonStudio.$inject = ['$scope', '$modal', '$http', '$stateParams', '$window', '$location', 'leafletData', 'urls', 'Auth', 'bsLoadingOverlayService'];

    function PolygonStudio($scope, $modal, $http, $stateParams, $window, $location, leafletData, urls, Auth, bsLoadingOverlayService) {
